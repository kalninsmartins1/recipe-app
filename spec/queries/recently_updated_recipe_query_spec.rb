...
RSpec.describe RecentlyUpdatedRecipesQuery do
  ...
  it 'recipes are ordered in descending order' do
    recipe_a = create(:recipe, chef_id: chef.id, created_at: 2.days.ago, updated_at: 1.day.ago)
    recipe_b = create(:recipe, chef_id: chef.id, created_at: 3.days.ago, updated_at: 2.hours.ago)
